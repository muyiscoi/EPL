...
"<label for='dob'> Date of Birth </label>".
	"<input type='date' name='dob' id='dob' required value='".$row1['dob']."' class='form-control' /><br>
<button style='float:right' class='btn btn-default'> Update Profile </button></form><br><hr>";
//address bit
	echo "<h4>Address</h4>".
...
"<label for='postcode'> PostCode </label>".
	"<input type='text' name='postcode' id='postcode' required value='".$row2['postcode']."' class='form-control' /><br>
<button style='float:right' class='btn btn-default'> Update Profile </button></form><br><hr>";
//password change bit
