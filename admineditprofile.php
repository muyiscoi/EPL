...
<form method='post' action='admineditprofile.php?user=".$user_id."'>".
	"<h2>Edit Profile</h2>".
...
header('Location:viewusers.php?user='.$user_id);
}
	//end email block
	//Address block
"<h3>Address</h3><hr>";
...
queryMysql($query19);
	...
	//end address block
//HTML button
echo "<br><button style='float:right' class='btn btn-default'> Update Profile </button></form>";
}
else {
